...
> Powered by a local [yt-dlp](https://github.com/yt-dlp/yt-dlp) server for audio extraction.
...
- **Flexible API Setup:** Uses a local server for audio extraction and configures your own API key for Groq.
